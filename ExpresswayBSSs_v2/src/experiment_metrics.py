...
def trajectory_metrics(result: dict, scenario: dict) -> dict:
    if len(result["rounds"]) != result["parameter_snapshot"]["num_periods"]:
    ...
    return {
        ...
        "reservation_unfinished_at_L": summary["active_reservations"],
        "reservation_unfinished_rate_at_L": summary["active_reservations"] / reservations if reservations else None,
